...
export default function TLS() {
  ...
  return (
    <>
      <Head>
        <title>TNG | Viewport TLS</title>
        <meta name="description" content="Integral Viewport Series / TLS" />
      ...
      <Container>
        <Components.ViewportNav
          ...
          className="width_100"
        />
        <Components.ViewportDetailSection variant="tls" className="width_100" />
      </Container>
    </>
  );
}
